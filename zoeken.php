...
<body>
    ...
    <form action="" method="get">
        ...
        <label for="search">Zoek klant: </label>
    ...
    $query = $db->prepare("SELECT klantnaam, klantadres, klantplaats, klantcontact, klantpostcode, klantcountry FROM klantadress WHERE klantnaam LIKE :search ORDER BY klantnaam");
    ...
    echo "<tr><th onclick='sortTable(0)'>klantnaam</th><th onclick='sortTable(1)'>klantadres</th><th onclick='sortTable(2)'>klantplaats</th><th onclick='sortTable(3)'>klantcontact</th></tr>";
    ...
    foreach ($result as $row) {
        ...
        echo "<tr><td>" . htmlspecialchars($row['klantnaam']) . "</td><td>" . htmlspecialchars($row["klantadres"]) . "</td><td>" . htmlspecialchars($row['klantplaats']) . "</td><td>" . htmlspecialchars($row['klantcontact']) . "</td></tr>" . htmlspecialchars($row['klantpostcode']) . "</td></tr>" . htmlspecialchars($row['klantcountry']) . "</td></tr>";
    }
    ...
    <script>
        ...
        function sortTable(column) {
            ...
            while (switching) {
                ...
                if (shouldSwitch) {
                    // Voert de wissel uit en markeert dat er een wisseling heeft plaatsgevonden.
